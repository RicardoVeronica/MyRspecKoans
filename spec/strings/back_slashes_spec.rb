describe 'back slash functionality' do
  it 'use double quotes to create strings that contains single quotes' do
    statement = "Don't be afraid"
    output = 'Don\'t be afraid' # do not try to interpret the character
  ...
  it 'use single quotes to create strings that contains double quotes' do
    statement = 'Franklin said: "Tell me and I forget. Teach me and I remember.
    Involve me and I learn"'
    output = "Franklin said: \"Tell me and I forget. Teach me and I remember.
    Involve me and I learn\""
